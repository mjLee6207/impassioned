	...
	<div class="footer">
		...
		<div class="footer-content-row">
			...
			<div class="footer-bottom-half">
				...
				<p>법인명(상호): (주)쵸비상 | 사업자등록번호: 315-88-01684 | 벤처기업: 제
					20200310103호</p>
				...
				<p class="legal">
					주식회사 쵸비상은 전자상거래법에 따른 통신판매중개업자입니다.<br> 중개하는 통신판매에 관하여 통신판매의
					당사자가 아니며, 책임을 지지 않습니다.<br> 정산/환불 등에 대한 책임은 (주)쵸비상이 지고 있음을

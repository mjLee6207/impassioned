...
<div class="container container-box">
    ...
    <div class="write-box">
        ...
        <form action="${pageContext.request.contextPath}/board/writeProcess.do" method="post" enctype="multipart/form-data">
		  ...
		  <button type="submit" class="btn btn-warning btn-submit" style="background-color:#1e8a57">등록하기</button>
		  <button type="button" class="btn btn-secondary btn-submit" onclick="history.back()">작성취소</button>
</div>
        </form>
    </div>
</div>
